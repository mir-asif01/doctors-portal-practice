...
const Banner = () => {
    return (
        <div className="hero px-5 py-10 home-banner">
            <div className="hero-content flex-col justify-between items-center lg:flex-row-reverse">
                ...
                <div className='md:w-1/2 w-full'>
                    ...
                    <button className="py-2 px-5 bg-gradient-to-r from bg-cyan-400 to-cyan-600 text-white rounded-md">Get Started</button>
                </div>
            </div>
        </div>
    );
